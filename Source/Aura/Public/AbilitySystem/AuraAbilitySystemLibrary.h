...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "AuraAbilitySystemLibrary|GameplayMechanics")
	static void GetLivePlayersWithinBox(const UObject* WorldContextObject, TArray<AActor*>& OutActors, const TArray<AActor*>& ActorsToIgnore, const FVector& BoxExtent, const FVector& BoxCenterOffset, const FVector& ActorLocation, const FRotator& ActorRotation);
