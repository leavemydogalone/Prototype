...
//	}
//
//	const ATurnExampleGameStateBase* const TurnSystem = UTurnBasedAbilitySystemBPLibrary::GetTurnSystem(EffectContextHandle.GetSourceObject() ? EffectContextHandle.GetSourceObject() : EffectContextHandle.GetInstigator());
//	if (!TurnSystem)
//	{
//		return false;
//	}
